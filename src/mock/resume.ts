...
export const resumeMock: Resume = {
  "profile": {
    ...
    "summary": "Full Stack Engineer with 4+ years of experience building scalable, high-performance web applications. Experienced in React, Next.js, Node.js, and TypeScript with a strong focus on clean architecture, system design, and delivering business impact in startup environments.",
    "location": "Pune, India"
  },
  "workExperiences": [
    {
